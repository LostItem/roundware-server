...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tag.filter'
        db.add_column('rw_tag', 'filter',
                      self.gf('django.db.models.fields.CharField')(default='--', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tag.filter'
        db.delete_column('rw_tag', 'filter')
    ...
    models = {
        'rw.asset': {
            ...
            'file': ('roundware.rw.fields.RWValidatedFileField', [], {'max_length': '100'}),
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'initialenvelope': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rw.Envelope']", 'null': 'True'}),
        ...
        'rw.envelope': {
            ...
            'assets': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['rw.Asset']", 'symmetrical': 'False', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'rw.tag': {
            ...
            'filter': ('django.db.models.fields.CharField', [], {'default': "'--'", 'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
