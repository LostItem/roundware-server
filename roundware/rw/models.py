...
class Audiotrack(models.Model):
    ...
    maxduration = models.FloatField(verbose_name='Min Playback Duration')
    mindeadair = models.FloatField(verbose_name='Min Silence')
    maxdeadair = models.FloatField(verbose_name='Max Silence')
    minfadeintime = models.FloatField(verbose_name='Min Fade In Time')
    maxfadeintime = models.FloatField(verbose_name='Max Fade In Time')
    minfadeouttime = models.FloatField(verbose_name='Min Fade Out Time')
    maxfadeouttime = models.FloatField(verbose_name='Max Fade Out Time')
    minpanpos = models.FloatField(verbose_name='Min Pan Position')
    maxpanpos = models.FloatField(verbose_name='Max Pan Position')
    minpanduration = models.FloatField(verbose_name='Min Pan Duration')
    maxpanduration = models.FloatField(verbose_name='Max Pan Duration')
    repeatrecordings = models.BooleanField(default=False, verbose_name='Repeat Recordings')
    tag_filters = models.ManyToManyField('Tag', blank=True, verbose_name='Tag Filters')
